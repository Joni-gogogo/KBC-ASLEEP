...
if __name__ == '__main__':
    ...
    parser.add_argument("--num_of_epochs", type=int, default=30, nargs="?",
                        help="Number of iterations.")
    parser.add_argument("--batch_size", type=int, default=1000, nargs="?",
                        help="Batch size.")
    parser.add_argument("--input_dropout", type=float, default=0.4, nargs="?",
                        help="Dropout rate for concatenated embeddings.")
    parser.add_argument("--hidden_dropout", type=float, default=0.4, nargs="?",
                        help="Dropout rate for composite embeddings.")
    parser.add_argument("--hidden_width_rate", type=int, default=5, nargs="?",
